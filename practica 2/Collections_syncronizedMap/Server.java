...
public class Server implements Runnable {
  ...
  public static Map<String, MySocket> Mapa = new HashMap(); //diccionari de parells (nick,socket)
  public static  Map <String, MySocket> clientsMap = Collections.synchronizedMap(Mapa);
